...
language = {
    'ptbr': {
        ...
        'edit': '\033[1;97mEDITAR ALUNOS    /',     #TÍTULO DE EDITAR ALUNO
            'edit_menu': '\033[1;97m              MENU EDITAR',
    ...
    'en': {
        ...
        'edit': '\033[1;97mEDIT STUDENTS    /',     #EDIT STUDENTS TITLE
            'edit_menu': '\033[1;97m               EDITING MENU',
...
def removing():
    ...
    while True:
        ...
        try:
            ...
            if remove == '':
                break
            remove = int(remove)-1  # -1 to go at the previous index (better to visualize 1 than 0)
            ...
            if choice == '1':
                ...
                while True:
                    ...
                    try:
                        ...
                        new_student = int(new_student)-1
                        print()
                        print(f'    {t['selected']} {group[new_student] [0]}')
                        print()
                        name = (input(f'        {t['name']}: ')).title().strip()
                        group[new_student][0] = name
                        print()

                        for g in range(1, 4):
                            grade = float(input(f'({t['current_grade']}: {group[new_student] [g]} ) | {g}° {t['grade']}'))
                            group[new_student][g] = grade
                        print()
